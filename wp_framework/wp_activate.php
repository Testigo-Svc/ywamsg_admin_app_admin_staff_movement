<?php
/**
 * Class To Handle WP Plugin Activate Event.
 */
    class YWAMSG_ADMIN_APP_ADMIN_STAFF_MOVEMENT_ACTIVATE {
        /**
        * Perform Plugin Activate 
        */
        public static function activate($new_db_version){
